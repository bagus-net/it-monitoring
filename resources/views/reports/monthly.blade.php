...
<div class="container-fluid mt-4 report-page">
    ...
    <section class="summary-grid mb-4">
        ...
        <div class="summary-card info"><span>Tanggal Terjadwal</span><strong>{{ $summary['dates'] }}</strong><div class="report-meter rose"><span style="width:{{ min(100, $summary['dates'] * 3) }}%"></span></div><small>akumulasi sepanjang tahun</small></div>
    </section>
...
<div class="report-insight"><i class="bi bi-calendar2-week"></i><div><strong>Insight jadwal bulanan</strong><span>{{ $summary['dates'] }} tanggal pelaksanaan tercatat untuk {{ $summary['programs'] }} program dan {{ $summary['equipments'] }} peralatan pada {{ $periodLabel }}.</span></div></div>
