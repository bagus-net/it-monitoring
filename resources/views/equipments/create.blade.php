...
<div class="container">
    ...
    <form method="POST" action="{{ route('equipments.store') }}" enctype="multipart/form-data">
        ...
        <div id="technicalDetails" class="technical-details d-none">
            ...
            <div data-type-section="cctv" class="type-fields d-none"><div class="row"><div class="col-md-3 mb-3"><label class="form-label">Resolusi Kamera</label><input name="technical_details[camera_resolution]" class="form-control" value="{{ old('technical_details.camera_resolution') }}" placeholder="2MP / 4MP / 8MP"></div><div class="col-md-3 mb-3"><label class="form-label">Tipe Lensa / Jenis Kamera</label><input name="technical_details[camera_type]" class="form-control" value="{{ old('technical_details.camera_type') }}" placeholder="Dome / Bullet / PTZ"></div><div class="col-md-3 mb-3"><label class="form-label">Jarak Night Vision</label><input name="technical_details[night_vision_range]" class="form-control" value="{{ old('technical_details.night_vision_range') }}" placeholder="30 meter"></div><div class="col-md-3 mb-3"><label class="form-label">Kapasitas Storage (NVR/DVR)</label><input name="technical_details[storage_capacity]" class="form-control" value="{{ old('technical_details.storage_capacity') }}" placeholder="2 TB HDD"></div></div><div class="row"><div class="col-md-3 mb-3"><label class="form-label">Jumlah Channel (NVR/DVR)</label><input name="technical_details[channel_count]" class="form-control" value="{{ old('technical_details.channel_count') }}" placeholder="16 Channel"></div><div class="col-md-3 mb-3"><label class="form-label">Koneksi</label><input name="technical_details[connection_type]" class="form-control" value="{{ old('technical_details.connection_type') }}" placeholder="PoE / Wi-Fi / Analog"></div><div class="col-md-3 mb-3"><label class="form-label">IP Camera</label><select name="technical_details[is_ip_camera]" class="form-control"><option value="">-- Pilih --</option><option value="Ya" {{ old('technical_details.is_ip_camera') === 'Ya' ? 'selected' : '' }}>Ya</option><option value="Tidak" {{ old('technical_details.is_ip_camera') === 'Tidak' ? 'selected' : '' }}>Tidak</option></select></div><div class="col-md-3 mb-3"><label class="form-label">Area / Titik Pemasangan</label><input name="technical_details[mounting_area]" class="form-control" value="{{ old('technical_details.mounting_area') }}" placeholder="Lobby / Gudang / Parkiran"></div></div></div>
        </div>
        <div class="mb-3">
